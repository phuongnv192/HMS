...
public class MailService {
    ...
    public void sendMailVerifyEmail(String recipientEmail, String passwordEncoder) throws Exception {
        String subject = "Verify email for HMS";
        StringBuilder content = new StringBuilder();
        content.append("Click this link for verify your account:\n");
        content.append(
                "http://localhost:8888/api/v1/auth/verify/" + HMSUtil.getMD5Hash(recipientEmail + passwordEncoder)
